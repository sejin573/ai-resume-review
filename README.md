...
이 프로젝트는 자기소개서를 작성하는 사용자가 더 빠르게 초안을 점검하고, 실제 제출 가능한 문장으로 다듬을 수 있도록 만드는 것을 목표로 시작했습니다. 단순히 AI 응답을 화면에 보여주는 수준이 아니라, 회원 관리, 첨삭 이력, 관리자 검수, 학습 데이터 관리까지 포함하는 서비스형 MVP로 확장했습니다.
